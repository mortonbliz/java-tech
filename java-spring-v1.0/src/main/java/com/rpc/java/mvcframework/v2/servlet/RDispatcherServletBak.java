package com.rpc.java.mvcframework.v2.servlet;

import com.rpc.java.mvcframework.annotation.*;
 ...
 * Created by Tom.
 */
public class RDispatcherServletBak extends HttpServlet{
    ...
    private void doDispatch(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        for (int i = 0; i < parameterTypes.length; i ++) {
            ...
            if(parameterType == HttpServletRequest.class){
                ...
                RRequestParam requestParam = (RRequestParam)parameterType.getAnnotation(RRequestParam.class);
    ...
    private void initHandlerMapping() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            if(!clazz.isAnnotationPresent(RController.class)){continue;}

            //保存写在类上面的@RRequestMapping("/demo")
            String baseUrl = "";
            ...
            for (Method method : clazz.getMethods()) {
                if(!method.isAnnotationPresent(RRequestMapping.class)){continue;}
    ...
    private void doAutowired() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            for (Field field : fields) {
                if(!field.isAnnotationPresent(RAutowired.class)){continue;}
